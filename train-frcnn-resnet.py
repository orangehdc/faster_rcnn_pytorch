...
from faster_rcnn.faster_rcnn_resnet import FasterRCNN, RPN   # changed
...
net.load_pretrained_cnn(state_dict)
print("load pretrained model successfully")

#network.load_pretrained_npy(net, pretrained_model)   #  re write load resnet
# model_file = '/media/longc/Data/models/VGGnet_fast_rcnn_iter_70000.h5'
#model_file = 'models/resnet_model/faster_rcnn_fix2_10000.h5'
...
for p in params:
    print( p['params'][0].size())
print(len(params))
print("fixed blocks", net.fixed_blocks)
def print_dict(d):
...
for step in range(start_step, end_step+1):
    ...
    #print(im_data.shape, im_info.shape, gt_boxes.shape, gt_ishard.shape)
    # forward
    ...
    if (step % 10000 == 0) and step > 0:
        save_name = os.path.join(output_dir, 'faster_rcnn_fix0_{}.h5'.format(step))
